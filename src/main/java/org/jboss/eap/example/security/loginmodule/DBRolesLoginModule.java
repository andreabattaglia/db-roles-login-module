 ...
 * @version $Revision$
 */
public class DBRolesLoginModule extends UsernamePasswordLoginModule {
    /**
    ...
    protected Group[] getRoleSets() throws LoginException {
        if (rolesQuery != null) {
            ...
            Group[] roleSets = Util.getRoleSets(username, dsJndiName,
                    txManagerJndiName, rolesQuery, this, suspendResume);
            return roleSets;
        }
        return new Group[0];
    }
